...
class Event_handling_within_class extends Frame implements ActionListener {

    TextField textField;

    Event_handling_within_class ()
    {
        // Component Creation
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        textField.setText("event handling by within class!");
    }

    public static void main(String[] args)
    {
        new Event_handling_within_class ();
    }
}
